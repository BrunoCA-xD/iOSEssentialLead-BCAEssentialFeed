...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompletWith: .failure(RemoteFeedLoader.Error.connectivity)) {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompletWith: .failure(RemoteFeedLoader.Error.invalidData)) {
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
        ...
        let item1 = makeItem(
            id: UUID(),
            imageURL: URL(string: "httpd://a-url.com")!
        )
        ...
        expect(sut, toCompletWith: .success(expectedItems)) {
    ...
    private func expect(
        ...
        toCompletWith expectedResult: RemoteFeedLoader.Result,
        when action: () -> Void,
